          ...
          <div class="container">
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto">
                <h3 class="login-heading mb-4">Hola denuevo!</h3>
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <div class="text-center">
                    ...
                    <a class="small letraL" href="{{ route('password.request') }}" style="font-size: 14px">Ha olvidado su contraseña?</a>
                    @endif
                </div>
                <hr class="my-4">
                <a class="btn btn-lg btn-dark btn-block btn-login text-uppercase font-weight-bold mb-2" href="/">Volver a inicio</a>
                </form>
              </div>
            </div>
          </div>
